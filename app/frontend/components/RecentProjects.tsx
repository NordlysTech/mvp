        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200 dark:border-gray-700">
              <th className="text-left font-semibold text-gray-700 dark:text-gray-300 p-4">
                Project Title
              </th>
              <th className="text-left font-semibold text-gray-700 dark:text-gray-300 p-4">
                Date
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      {projects.map((project) => (
        <Card
          key={project.id}
          className="bg-white dark:bg-gray-800/50 backdrop-blur-lg border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/70 transition-colors"
        >
